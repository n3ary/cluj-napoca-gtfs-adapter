...
import { getAllCategories } from '../merge/routeCategory.js';

/**
 * Build the CSV bodies for `networks.txt` and `route_networks.txt`.
 *
 * @param {Array<{ route_id: string, route_short_name: string, route_long_name: string, route_desc: string }>} routes
